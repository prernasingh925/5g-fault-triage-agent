  ...
  return (
    <div className="home-page">
      <div className="home-hero">
        ...
        <p>AI-powered RAN fault diagnostics using the UAP Intelligence Layer. Detect, classify and remediate 5G NR incidents in minutes.</p>
